  ...
  <body onLoad="start()">
    ...
    <div id="discussionContainer" class="container headerBar">
      ...
      <div id="newComment" class="discussion standardBox">
        <p class="username"><a href="">Comment</a></p><input id="commentInput" type="text" placeHolder="Add a comment here"/><p id="clock" class="clockFinished">00:00:00</p>
      </div>
      <div id="mainDiscussion" class="discussion standardBox">
        ...
        <div id="mainDiscussion" class="discussion standardBox">
          <p class="score">0</p><p class="upvote" onclick="upvote(this, 1)">▲</p><p class="downvote" onclick="upvote(this, -1)">▼</p><p class="reply" onclick="reply(this)">@reply</p><p class="username"><a href="user.html">bob1212</a></p><p onclick="hideChildren(this)">Donec eget semper nisi. Vivamus condimentum finibus eros sed ultricies.</p>
        </div>
      </div>
      <div id="mainDiscussion" class="discussion standardBox">
