    ...
    <div id="discussionContainer" class="container headerBar">
      ...
      <div id="mainDiscussion" class="discussion standardBox">
        ...
        <div id="mainDiscussion" class="discussion standardBox">
          ...
          <div id="mainDiscussion" class="discussion standardBox">
            <p class="score">6</p><p class="upvote" onclick="upvote(this, 1)">▲</p><p class="downvote" onclick="upvote(this, -1)">▼</p><p class="reply" onclick="reply(this)">@</p><p class="username"><a href="user.html">bob1212</a></p><p onclick="hideChildren(this)">Donec eget semper nisi. Vivamus condimentum finibus eros sed ultricies.</p>
          </div>
        </div>
      </div>
      <div id="mainDiscussion" class="discussion standardBox">
        <p class="score">4</p><p class="upvote" onclick="upvote(this, 1)">▲</p><p class="downvote" onclick="upvote(this, -1)">▼</p><p class="reply" onclick="reply(this)">@</p><p class="username"><a href="user.html">bob1212</a></p><p onclick="hideChildren(this)">Ut ut rutrum tortor. Nulla at sollicitudin diam, tempus semper nisl. Vivamus non est at massa scelerisque tempus. Phasellus at leo pretium, lacinia sem ut, faucibus est. Etiam turpis dolor, cursus in tincidunt eget, consectetur a est. Proin sollicitudin ligula eget turpis condimentum dapibus.</p>
      </div>
    </div>
  </body>
</html>
